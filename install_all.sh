...
export ENGINEPLUS_REPO_PREFIX=YOUR_REPO_URL/mobvista
export ENGINEPLUS_REPO_TAG=engineplus-2.0.1
export ENGINEPLUS_NAMESPACE=engineplus
export ENGINEPLUS_INGRESS_ENABLED=true
export ENGINEPLUS_INGRESS_HOST=YOUR_INGRESS_HOST_DOMAIN
export ENGINEPLUS_S3_PREFIX=YOUR_S3_PREFIX
export ENGINEPLUS_SPARK_SERVICEACCOUNT=spark
export ENGINEPLUS_ROLE_ARN=arn:aws:iam::YOUR-ACCOUNT-NUMBER:role/YOUR-ROLE-NAME
...
export ENGINEPLUS_AIRFLOW_DB_RDS_MYSQL_HOST="YOUR_RDS_ADDRESS"
export ENGINEPLUS_AIRFLOW_DB_RDS_MYSQL_PORT=3306
export ENGINEPLUS_AIRFLOW_DB_RDS_MYSQL_USER="YOUR_RDS_USER_NAME"
export ENGINEPLUS_AIRFLOW_DB_RDS_MYSQL_PASSWORD="YOUR_RDS_PASSWORD"
export ENGINEPLUS_AIRFLOW_DB_RDS_MYSQL_DATEBASE="YOUR_RDS_DATABASE_FOR_AIRFLOW"
